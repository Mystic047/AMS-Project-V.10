                ...
                <div class="card-body">
                    <form class="row g-3" action="{{ route('coordinator.update', $coordinators->coordinators_id) }}" method="POST">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="inputAddress" name="coordinators_id" placeholder="ถ้า Auto ก็เอาออก" value="{{ $coordinators->coordinators_id }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control" id="inputEmail4" name="firstname" value="{{ $coordinators->firstname }}">
                        </div>
                        <div class="col-md-5">
                            <label for="inputPassword4" class="form-label">Lastname</label>
                            <input type="text" class="form-control" id="inputPassword4" name="lastname"  value="{{ $coordinators->lastname }}">
                        </div>
                        <div class="col-md-2">
                            <label for="inputPassword4" class="form-label">Nickname</label>
                            <input type="text" class="form-control" id="inputPassword4"  name="nickname" value="{{ $coordinators->nickname }}">
                        </div>
                        <div class="col-12">
                            <label for="inputAddress" class="form-label">faculty_id</label>
                            <input type="text" class="form-control" id="inputAddress" name="faculty_id" value="{{ $coordinators->faculty_id }}">
                        </div>
                        <div class="col-md-6">
