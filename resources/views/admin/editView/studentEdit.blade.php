...
@section('content')
    ...
    <div class="container">
        <div class="card my-5">
            <div class="card-body">
                <form class="row g-3" action="{{ route('student.update', $students->userId) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="col-12">
                        <label for="userId" class="form-label">รหัสนักศึกษา</label>
                        <input type="text" class="form-control" id="userId" name="userId" placeholder="ถ้า Auto ก็เอาออก" value="{{ $students->userId }}" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="nickName" name="nickName" value="{{ $students->nickName }}">
                    </div>
                    <div class="col-md-6">
                        <label for="areaId" class="form-label">รหัสสาขา</label>
                        <input type="text" class="form-control" id="areaId" name="areaId" value="{{ $students->areaId }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ route('student.manage') }}" class="btn btn-danger mx-1 float-end">ยกเลิก </a>
                    </div>
                </form>
                            </div>
        </div>
