            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                      ...
                      <tr>
                          <td class="col-3">{{ $professor->professors_id }}</td>
                          <td class="col-4">
                              <div class="d-flex align-items-center">
                                   <img src="{{ asset('storage/'.$professor->profile_picture) }}" class="rounded-circle me-2" alt="Avatar" style="width: 40px; height: 40px; object-fit: cover;">
                                  <div>{{ $professor->firstname }} {{ $professor->lastname }}</div> 
                              </div>
                          </td>
                          <td class="col-3">{{ $professor->faculty_id }}</td> <!-- Assuming faculty relation exists -->
                          <td class="col-2">
