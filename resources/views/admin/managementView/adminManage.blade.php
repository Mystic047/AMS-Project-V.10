        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <div class="search-bar">
                    ...
                    <a href="{{ route('admin.showCreate') }}" class="btn btn-primary">Add New</a>
                </div>
                      ...
                      <tr>
                          ...
                          <td class="col-4">
                              <div class="d-flex align-items-center">
                                   <img src="{{ asset('storage/'.$admin->profile_picture) }}" class="rounded-circle me-2" alt="Avatar" style="width: 40px; height: 40px; object-fit: cover;">
                          ...
                          <td class="col-2">
                            {{-- <button class="btn btn-warning btn-sm" onclick="window.location.href = '{{ route('student.edit', $student->id) }}'"> --}}
                              ...
                              <form action="{{ route('admin.delete', $admin->admin_id) }}" method="post" style="display: inline;">
                                  @csrf
                                  @method('DELETE')
